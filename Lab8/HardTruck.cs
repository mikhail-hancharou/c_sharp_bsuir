...
namespace lab6
{
    class HardTruck : Vehicle, IComparable<HardTruck>
    {
        public int CompareTo(HardTruck hardTruck)
        {
            if (WeightPossibilities == hardTruck.WeightPossibilities)
                return 0;
            else if (WeightPossibilities > hardTruck.WeightPossibilities)
                return 1;
            else
                return -1;
        }
