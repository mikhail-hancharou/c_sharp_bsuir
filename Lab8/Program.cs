...
namespace lab6
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            RaceCar rangeRover = new RaceCar();
            rangeRover.Up += DisplayMess;
            rangeRover.Show += DisplayMess;
            rangeRover.CompareTo(pecoe);
            Console.ReadKey();
        }

        private static void DisplayMess(string mess)
        {
